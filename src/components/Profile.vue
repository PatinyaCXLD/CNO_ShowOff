<template>
    <div class="text-center w-[240px] h-fit border border-gray-200 rounded-md shadow-md p-3.5 scale-100  bg-white overflow-hidden hover:scale-105 ease-in duration-100 hover:bg-slate-300" title="Patinya Saichantadee">
        <div class="relative content-center">
            ...
            <div class="text-blue-400 font-bold text-[20px] mt-[7px]">
                {{name}}
            </div>
            <div class="font-bold">
                {{nickname}} <br>
            ...
            <div class="text-red-600">
                {{team}} <p class="text-green-600 inline">{{year}}</p>
            </div>
            <div>
                {{birthday}}
            </div>
...
export default {
    props : {
        ...
        image :{
            type: String,
            default : "https://t4.ftcdn.net/jpg/04/43/94/65/360_F_443946521_H2fUJJyxk2YuqwQP1dUvg0JavzhanSOV.jpg",
        },
        facebook :{
            type: String,
            default : "/profile"
